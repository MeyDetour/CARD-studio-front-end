import "./style.css";
export default function CustomCard({ card, dataKey, radius, hoverable = false, isSelected = false, children, classAdded, action }) {
  if (!card) {
  ...
  if (!card.url) {
    ...
    return "PLEASE PROVIDE URL OF THE CARD";
  }
