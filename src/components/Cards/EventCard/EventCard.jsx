...
export default function EventCard({ action, event, isSelected ,alertMessages, displayIcons = false, actionOnAdd, actionOnRemove,children,classAdded=""}) {
  ...
  return (
    <div
      onClick={action}
      className={`eventCard ${isSelected ? "Selected" : ""} ${classAdded}`}
    >
      {children}
